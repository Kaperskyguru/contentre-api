...
export type SignedUpThrough = 'AIRBANK' | 'GOOGLE'
...
> = {
  ...
  forceUserToVerifyPhoneNumber?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationForceUserToVerifyPhoneNumberArgs, 'token' | 'userId'>
  >
  loginUser?: Resolver<
    ResolversTypes['User'],
    ParentType,
  ...
  >
  userSwitchedLanguage?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationUserSwitchedLanguageArgs, 'newLanguage'>
  >
...
> = {
  findUser?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryFindUserArgs, 'uuid'>
  >
