                  ...
                  <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="email-masthead">
                        <a href="https://contentre.io?source=password_changed_email" class="f-fallback email-masthead_name">
                          ...
                          <tr>
                            <td class="content-cell">
                              <div class="f-fallback">
                                ...
                                <p>The password connected to your Contentre account was changed. If you didn't request this change, talk to us to revert it.</p>
                                <p>If you have any questions, please <a href="mailto:support@contentre.io">contact support</a> if you have questions. — we're always happy to help out.</p>
                                <p>Talk soon,
